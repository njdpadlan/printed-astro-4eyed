...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/RequestQuote/Hero.astro", void 0);
...
const $$RequestQuoteForm = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="form-card"> <!-- Add https://formsubmit.co/email-here later in the action --> <div class="form-p"> <p>Input fields that are marked with <span class="form-symbol">*</span> are required. </p> </div> <form action="https://formsubmit.co/info@printedonline.ca" method="post" name="requestquote" enctype="multipart/form-data"> <!-- Template type --> <input type="hidden" name="_template" value="table"> <div> <label${addAttribute(formDetails.FullName, "for")}>${formDetails.FullName} <span class="form-symbol">*</span></label> <input${addAttribute(formDetails.FullName, "id")} type="text" name="name" placeholder="Enter your full name here."> <p id="name_errormsg"></p> </div> <div> <label for="phone">${formDetails.Phone} <span class="form-symbol">*</span></label> <input id="phone" type="number" name="phone" placeholder="Enter your phone number here."> <p id="phone_errormsg"></p> </div> <div> <label${addAttribute(formDetails.Email, "for")}>${formDetails.Email}</label> <input id="email" name="email" placeholder="Enter your email address here."> <p id="email_errormsg"></p> </div> <div> <label${addAttribute(formDetails.CompanyName, "for")}>${formDetails.CompanyName}</label> <input${addAttribute(formDetails.CompanyName, "id")} type="text" name="company" placeholder="Enter your company name here."> </div> <div class="product-type-quantity"> <div> <label for="product-type">${formDetails.ProductType} <span class="form-symbol">*</span></label> <select name="product_type" id="product-type"> <option value="">Choose a product</option> <option value="Linerless Label">Linerless Label</option> <option value="Pressure Seal">Pressure Seal Forms</option> <option value="Integrated Form">Integrated Form/Labels</option> <option value="Laser-Cut Sheet Form">Laser-Cut Sheet Forms</option> <option value="Snapset Form">Snapset Form</option> <option value="Continuous Form">Continuous Forms</option> <option value="Custom Envelopes">Custom Envelopes</option> <option value="Other">Other</option> </select> <p id="subject_errormsg"></p> </div> <div> <label for="quantity">${formDetails.Quantity} <span class="form-symbol">*</span></label> <input${addAttribute(formDetails.Quantity, "id")} type="number" name="quantity" placeholder="Enter your quantity here."> <p id="quantity_errormsg"></p> </div> </div> <div> <label class="label-upload"${addAttribute(formDetails.FileUpload, "for")}>${formDetails.FileUpload}</label> <input${addAttribute(formDetails.FileUpload, "id")} class="file-upload" type="file" name="attachment" placeholder="Upload your file here."> <p class="upload-p">Upload a file up to 5MB.</p> </div> <div> <label${addAttribute(formDetails.AdditionalDetails, "for")}>${formDetails.AdditionalDetails} <span class="form-symbol">*</span></label> <textarea${addAttribute(formDetails.AdditionalDetails, "id")} name="message" class="message-box" placeholder="Enter additional details here. Examples include sizes, materials, colours, specifications, questions, and details from file uploads."></textarea> <p id="message_errormsg"></p> </div> <input type="submit"${addAttribute(formDetails.requestquoteBtn, "value")} class="submit-btn"> </form> </div> ${renderScript($$result, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/RequestQuote/RequestQuoteForm.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/RequestQuote/RequestQuoteForm.astro", void 0);
...
const $$RequestQuote = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Head", $$Head, { "seoData": seoPageData })} ${renderComponent($$result, "Layout", $$Layout, {}, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="white-space"></div> <div class="background-form"> <div class="forms-page-wrapper"> ${renderComponent($$result2, "Hero", $$Hero, { "requestQuoteHero": heroData })} ${renderComponent($$result2, "RequestQuoteForm", $$RequestQuoteForm, { "formDetails": requestquoteFormData })} </div> </div> ` })}`;
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/pages/request-quote.astro", void 0);

const $$file = "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/pages/request-quote.astro";
