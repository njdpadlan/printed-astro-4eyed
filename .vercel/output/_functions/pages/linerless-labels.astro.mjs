...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/LinerlessLabel/Hero.astro", void 0);
...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/LinerlessLabel/SustainableLabel.astro", void 0);
...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/LinerlessLabel/WhatIs.astro", void 0);
...
const $$LinerlessLabels = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Head", $$Head, { "seoData": seoPageData })} ${renderComponent($$result, "Layout", $$Layout, {}, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, { "linerlessHero": heroData })} ${renderComponent($$result2, "WhatIs", $$WhatIs, { "productWhatIs": linerlessWhatIsData })} ${renderComponent($$result2, "SustainableLabel", $$SustainableLabel, { "productSustainable": sustainablelabelData })} ` })}`;
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/pages/linerless-labels.astro", void 0);

const $$file = "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/pages/linerless-labels.astro";
