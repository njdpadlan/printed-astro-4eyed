...
const $$ContactUsForm = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="form-card"> <div class="form-p"> <p>Input fields that are marked with <span class="form-symbol">*</span> are required. </p> </div> <form action="https://formsubmit.co/info@printedonline.ca" method="post" name="contactus"> <input type="hidden" name="_template" value="table"> <div> <label for="name">${formDetails.FullName} <span class="form-symbol">*</span></label> <input id="name" type="text" name="name" placeholder="Enter your full name here."> <p id="name_errormsg"></p> </div> <div> <label for="phone" class="label">${formDetails.Phone}<span class="form-symbol"> *</span></label> <input id="phone" type="number" name="phone" placeholder="Enter your phone number here."> <p id="phone_errormsg"></p> </div> <div> <label for="email">${formDetails.Email}</label> <input id="email" name="email" placeholder="Enter your email address here."> <p id="email_errormsg"></p> </div> <div> <label${addAttribute(formDetails.Message, "for")}>${formDetails.Message} <span class="form-symbol">*</span></label> <textarea${addAttribute(formDetails.Message, "id")} name="message" class="message-box" placeholder="Enter your message here."></textarea> <p id="message_errormsg"></p> </div> <input type="submit"${addAttribute(formDetails.sendmessageBtn, "value")} class="submit-btn"> </form> </div> ${renderScript($$result, "/Users/rikuowada/Documents/NAIT/Sept-Dec 2025/DMNIT2590/printed-website/printed-astro-4eyed/src/components/ContactUs/ContactUsForm.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/rikuowada/Documents/NAIT/Sept-Dec 2025/DMNIT2590/printed-website/printed-astro-4eyed/src/components/ContactUs/ContactUsForm.astro", void 0);
...
}, "/Users/rikuowada/Documents/NAIT/Sept-Dec 2025/DMNIT2590/printed-website/printed-astro-4eyed/src/components/ContactUs/Hero.astro", void 0);
...
const $$ContactUs = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "seo": seoPageData }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="background-form"> <div class="forms-page-wrapper"> ${renderComponent($$result2, "Hero", $$Hero, { "contactUsHero": heroData })} ${renderComponent($$result2, "ContactUsForm", $$ContactUsForm, { "formDetails": contactusFormData })} </div> </div> ` })}`;
}, "/Users/rikuowada/Documents/NAIT/Sept-Dec 2025/DMNIT2590/printed-website/printed-astro-4eyed/src/pages/contact-us.astro", void 0);

const $$file = "/Users/rikuowada/Documents/NAIT/Sept-Dec 2025/DMNIT2590/printed-website/printed-astro-4eyed/src/pages/contact-us.astro";
