...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/IntegratedForm/Hero.astro", void 0);
...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/IntegratedForm/WhatIs.astro", void 0);
...
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/components/IntegratedForm/SmartEfficient.astro", void 0);
...
const $$IntegratedFormLabels = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Head", $$Head, { "seoData": seoPageData })} ${renderComponent($$result, "Layout", $$Layout, {}, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, { "integratedFormHero": heroData })} ${renderComponent($$result2, "WhatIs", $$WhatIs, { "productWhatIs": integratedformWhatIsData })} ${renderComponent($$result2, "SmartEfficient", $$SmartEfficient, { "productSmartEfficient": smartformData })} ` })}`;
}, "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/pages/integrated-form-labels.astro", void 0);

const $$file = "C:/Users/njdpa/Desktop/printed-astro/astro-frontend/src/pages/integrated-form-labels.astro";
